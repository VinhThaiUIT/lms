...
import 'package:opencentric_lms/data/model/book_store_model/book_store_model.dart';
...
class BookStoreController extends GetxController {
  ...
  Future<void> getLatestBooks() async {
    final response = await BookStoreRepository(apiClient: Get.find())
        .getLatestBooks(currentPage);
