...
class ResourceScreen extends StatelessWidget {
  ...
  const ResourceScreen({super.key, required this.courseID});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<ResourceController>(
        initState: (state) =>
            Get.find<ResourceController>().getResourceList(courseID),
        builder: (controller) {
          return controller.isResourceListLoading
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          DateTime startDate = DateTime.parse(
              resourceController.assignmentList.elementAt(index).createdAt!);
                  ...
                  children: [
                    Padding(
                      ...
                      child: CircleAvatar(
                        ...
                        radius: 20,
                        child: Text(resourceController.assignmentList
                            .elementAt(index)
                            .title!
                            .substring(0, 1)),
                      ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text(
                                resourceController.assignmentList
                                    .elementAt(index)
                                    .title!,
                          ...
                          InkWell(
                            onTap: () {
                              _launchUrl(Uri.parse(resourceController
                                  .assignmentList
                                  .elementAt(index)
                                  .source!));
                            },
