  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetBuilder<AssignmentController>(
        initState: (state) =>
            Get.find<AssignmentController>().getAssignmentList(),
        builder: (controller) {
          return const InDevelopment();
          return controller.isAssignmentListLoading
    ...
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          DateTime startDate = DateTime.parse(
              assignmentController.assignmentList.elementAt(index).createdAt!);
                  ...
                  children: [
                    Padding(
                      ...
                      child: CircleAvatar(
                        ...
                        radius: 20,
                        child: Text(assignmentController.assignmentList
                            .elementAt(index)
                            .title!
                            .substring(0, 1)),
                      ),
                      ...
                      child: Row(
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              Text(
                                assignmentController.assignmentList
                                    .elementAt(index)
                                    .title!,
                          ...
                          InkWell(
                            onTap: () {
                              Get.toNamed(
                                  RouteHelper.getAssignmentDetailsScreen(
                                      assignmentController.assignmentList
                                          .elementAt(index)));
                            },
                            child: Container(
