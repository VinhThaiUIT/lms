...
import 'package:opencentric_lms/feature/conversation/model/conversation_model.dart';
import 'package:opencentric_lms/feature/conversation/repo/conversation_repo.dart';
...
class ConversationController extends GetxController implements GetxService {
  ...
  Future<void> getChannelListBasedOnReferenceId(
      int offset, String referenceId) async {
    _channelList = [];

    update();
    Response response = await conversationRepo.getChannelListBasedOnReferenceId(
        offset, referenceId);
  ...
  Future<void> createChannel(String userID, String referenceID,
      {String name = 'Chatting Page', String image = ''}) async {
    _isLoading = true;
    update();
    Response response =
