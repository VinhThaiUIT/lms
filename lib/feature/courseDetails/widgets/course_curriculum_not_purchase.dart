...
class CourseCurriculumNotPurchase extends StatelessWidget {
  final List<Section> sections;
  final CourseDetailNotPurchaseController controller;
  const CourseCurriculumNotPurchase(
  ...
  Widget _item(BuildContext context, Lesson lesson, String sectionID) {
    return InkWell(
      onTap: () {
        if (!(controller.isHavePermissionCourse ?? true)) {
          return;
        }
