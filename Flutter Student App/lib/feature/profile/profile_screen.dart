...
import 'package:opencentric_lms/feature/profile/widgets/other_benefit.dart';
import 'package:opencentric_lms/feature/profile/widgets/profile_app_bar_content.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: GetBuilder<UserController>(
          ...
          builder: (controller) {
            return controller.userData == null || controller.isLoading == true
                ? const LoadingIndicator()
                : mainUI(context, controller.userData);
          }),
    );
  }
