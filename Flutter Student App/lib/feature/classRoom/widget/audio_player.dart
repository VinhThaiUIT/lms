...
import 'package:opencentric_lms/controller/my_audio_player_controller.dart';
  ...
  Widget build(BuildContext context) {
    return Dialog(
      child: GetBuilder<MyAudioPlayerController>(
          initState: (state) => Get.find<MyAudioPlayerController>().initPlayer(
              lesson.link, courseID, lesson.id.toString(), sectionID),
          builder: (controller) {
            return Container(
