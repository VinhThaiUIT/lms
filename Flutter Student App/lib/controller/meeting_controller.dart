...
import 'package:opencentric_lms/data/model/meeting_model/meeting_model.dart';
import 'package:opencentric_lms/repository/meeting_repository.dart';
  ...
  Future<void> getMeetingList() async {
    ...
    if (response != null && response.statusCode == 200) {
      if (response.body['success'] == true) {
        List<MyMeeting> list =
            MeetingModel.fromJson(response.body).data!.myMeeting!;
